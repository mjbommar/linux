 ...
 *
 * If the kernel-side syscall return path carries a valid address but
 * userspace sees 0, this isolates the corruption to the kernel->user
 * RAX transport rather than glibc.
 *
