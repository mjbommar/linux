...
`../redesign/04-risks/decisions-log.md`.
...
- `../redesign/01-architecture/three-layers.md` — five blocks edited
...
- `../redesign/01-architecture/README.md` — Layer 1 diagram box
  updated.
- `../redesign/01-architecture/data-flow.md` — five `syscall_dispatch`
  references swept to `run_userspace` across four profile walkthroughs.
- `../redesign/02-workstreams/README.md` — one prose reference swept.
- `../redesign/02-workstreams/A-backend-abstraction/01-ops-table.md` —
...
`../redesign/02-workstreams/A-backend-abstraction/notes/recon-audit.md`.
...
documented in `../redesign/02-workstreams/A-backend-abstraction/01-ops-table.md`
...
`../redesign/02-workstreams/A-backend-abstraction/05-contract.md`
