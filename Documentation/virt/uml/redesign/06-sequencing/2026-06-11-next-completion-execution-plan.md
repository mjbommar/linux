...
7. **Deterministic workload selftest.**
   ...
   `kvm-record-smoke` now includes the task-owned 386-entry replay leg, live
   raw-time and RDTSC/RDTSCP rejection legs, plus a live-negative
   `getrandom(2)` strict rejection leg.
