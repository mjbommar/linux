...
- Expand the remaining P4.3 measurements: final paced/unpaced UDP acceptance
  ...
  deltas, and initial privileged perf-stat smoke are diagnostic aids, not
  substitutes for that acceptance gate.
