...
2. Vector2 replacement claims must match validation evidence. Current-head
   focused smokes, KUnit, bounded KVM-v2/vector2 Tier 3 path smoke, and the
   normal guest-to-host TCP gate pass, but the natural 7200-second seccomp run,
   full KVM-v2 Tier 3 coverage, UDP/syscall/CPU performance coverage, and
