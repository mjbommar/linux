...
| Launcher | `umlctl up/down/ps/logs` | Present-validated | `next`, `umlctl-deploy` | Keep. | `umlctl-smoke` PASS on rebuilt `bb092119158b`; `cargo test --locked` PASS with 213 tests in `tools/uml/uml-launcher`, 2026-06-11. |
