...
2. Vector2 replacement claims must match validation evidence. Current-head
   ...
   normal guest-to-host TCP gate, and most fixed-byte bidirectional TCP cells
   pass, but the host-to-guest 1 MiB regression, natural 7200-second seccomp
   run, full KVM-v2 Tier 3 coverage, UDP/syscall/CPU performance coverage,
