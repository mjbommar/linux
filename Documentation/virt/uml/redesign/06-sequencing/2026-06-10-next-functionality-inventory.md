...
- The current-head vector2 validation refresh passes on the rebuilt current
  ...
  Django-v2 and FastAPI-v2. Full Tier 3, 7200-second seccomp, and
...
2. Vector2 replacement claims must match validation evidence. Current-head
   ...
   3 path smoke, the normal guest-to-host TCP gate, lazy-RX allocation-churn
   cleanup, RX checksum feature alignment, and most fixed-byte bidirectional
   TCP cells pass, but
