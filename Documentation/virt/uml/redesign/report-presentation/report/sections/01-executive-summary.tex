...
\node[box,below=of arch] (state) {\textbf{Current state at \ReportDate.} Backend abstraction, static-key infrastructure, profile work, \texttt{umlctl}, selftests, and \KVMvTwo{} are in-tree. \KVMvTwo{} has cleared Phases A--H, G.1/G.2, and I; Phase J validation is in progress.};
...
Known historic weaknesses & High trap cost and lack of realistic SMP limited \UML{} as workloads and fuzzers became more demanding. & \KVMvTwo{} and Phase J directly target syscall cost, SMP state ownership, parity, and long-run reliability. \\
\bottomrule
\end{tabularx}
\end{table}
...
\metriccard{UMLGreen}{200/200}{\KVMvTwo{} Phase J\\two-hour soak}\hfill
...
Functional headline & \KVMvTwo{} has cleared core Phases A--H, SMP phases G.1/G.2, and the Phase I lift; formal Phase J validation remains open \\
...
D & KVM backend & \progresspill & \KVMvTwo{} is functional and performant; Phase J, Tier 2/3, LTP, and upstream packaging are the active edge. \\
\bottomrule
\end{tabularx}
\end{table}
...
it is whether Phase J can demonstrate enough sustained reliability
