...
This is the changed contract reviewers should keep in mind: v2's
core claim is not only that KVM can run \UML{} faster, but that each
architectural state item has a declared home and a declared transition
rule.
