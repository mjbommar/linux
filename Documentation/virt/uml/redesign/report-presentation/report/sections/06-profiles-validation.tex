...
\node[rung,live,below=0.08cm of l1] (l2) {\textbf{internal contracts:} KUnit, marshal, byte-shape checks};
...
\node[rung,live,below=0.08cm of l4] (l5) {\textbf{performance gates:} prevent fast-path regression};
\node[rung,live,below=0.08cm of l5] (l6) {\textbf{real workload boot:} Python and stress workloads};
\node[rung,prog,below=0.08cm of l6] (l7) {\textbf{sustained validation:} 24-hour run plus Tier 2/3 and LTP curation};
\end{tikzpicture}
\caption{Validation ladder. Short gates protect the inner loop; sustained validation is reserved for milestone candidates.}
\end{figure}

\subsection{Sustained Validation Pilot}

\begin{table}[h]
\centering
\caption{First post-T57 sustained-validation pilot, 2026-05-14.}
\small
