...
8 & Review pressure & Put pressure on the data model, validation breadth, upstream slicing, and replay/snapshot claims. \\
\bottomrule
\end{tabularx}
\end{frame}
...
\begin{itemize}
  \item Internal diary phase labels map to the milestone sequence above.
  \item The remaining frontier is sustained workload breadth before upstreaming.
\end{itemize}
\end{frame}
...
\Large
\textbf{The branch is now an implementation with a validation frontier.}
...
\begin{itemize}
  ...
  \item The next credible milestone is sustained validation and an upstreamable series plan.
\end{itemize}
\end{frame}
