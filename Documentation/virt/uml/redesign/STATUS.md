...
time outside the log. Replayable raw-time payloads, direct `RDTSC`/`RDTSCP`
runtime evidence, explicit signal-event ordering, and replayable
device/network/hostfs events remain open. The public
