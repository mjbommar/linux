...
| Multiqueue TAP/fd KCSAN and distribution | TAP multiqueue works and queue counters move; fd multiqueue core opens contiguous inherited fd ranges under KUnit; launcher fd multiqueue and KCSAN absent | Partial |
...
- wire `umlctl` launcher-owned fd multiqueue handoff and validate it
  live;
