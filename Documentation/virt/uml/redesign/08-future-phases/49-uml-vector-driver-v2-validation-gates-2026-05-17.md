...
Findings:
  ...
  - **UDP / syscall-rate / CPU-utilisation:** initial paced 1 MiB UDP
    ...
    per-process endpoint CPU seconds plus host-to-guest UML process metric
    deltas in `summary.tsv`; unpaced/larger UDP, syscall-rate, and full
