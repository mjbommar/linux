...
Findings:
  ...
  - **UDP / syscall-rate / CPU-utilisation:** current-head repeat-2 UDP
    evidence passes buffered unpaced 1 MiB and paced 8 MiB in both
    directions.  Unpaced 8 MiB host-to-guest UDP still misses exact-byte
    completion and remains an explicitly bounded non-acceptance shape.  The
